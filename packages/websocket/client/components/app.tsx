...
import { SERVER_EVENT, ServerFn } from "../../types/websocket";
...
export const App: FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    socket.on(SERVER_EVENT.FORWARD_OFFER, onReceiveOffer);
    socket.on(SERVER_EVENT.NOTIFY_ERROR, onNotifyError);
    setId(socket.id);
    ...
    return () => {
      ...
      socket.off(SERVER_EVENT.FORWARD_OFFER, onReceiveOffer);
      socket.off(SERVER_EVENT.NOTIFY_ERROR, onNotifyError);
    };
  }, [
    onClose,
    onError,
