...
export interface SocketEventParams {
  // CLIENT
  [CLINT_EVENT.JOIN_ROOM]: { id: string; device: DEVICE_TYPE };
  ...
  // SERVER
  [SERVER_EVENT.JOINED_ROOM]: { id: string; device: DEVICE_TYPE };
  [SERVER_EVENT.JOINED_MEMBER]: { initialization: { id: string; device: DEVICE_TYPE }[] };
